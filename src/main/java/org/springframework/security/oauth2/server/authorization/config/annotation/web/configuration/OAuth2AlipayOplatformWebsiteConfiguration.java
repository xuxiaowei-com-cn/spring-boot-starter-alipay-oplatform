...
public class OAuth2AlipayOplatformWebsiteConfiguration {
	...
	public AlipayOplatformWebsiteService alipayOplatformWebsiteService() {
		return new InMemoryAlipayOplatformWebsiteService(alipayOplatformWebsiteProperties);
	}
