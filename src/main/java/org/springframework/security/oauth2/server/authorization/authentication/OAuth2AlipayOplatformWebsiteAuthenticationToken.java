...
public class OAuth2AlipayOplatformWebsiteAuthenticationToken extends OAuth2AuthorizationGrantAuthenticationToken {
	 ...
	 * 授权类型：支付宝 网站应用
	 */
	public static final AuthorizationGrantType ALIPAY_OPLATFORM_WEBSITE = new AuthorizationGrantType(
			"alipay_oplatform_website");
	 ...
	 */
	public OAuth2AlipayOplatformWebsiteAuthenticationToken(Authentication clientPrincipal,
		...
		super(OAuth2AlipayOplatformWebsiteAuthenticationToken.ALIPAY_OPLATFORM_WEBSITE, clientPrincipal,
