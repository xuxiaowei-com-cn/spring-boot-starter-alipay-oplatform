 ...
 */
public interface AlipayOplatformWebsiteService {
	 ...
	 * 拦截处理此异常
	 */
	AlipayOplatformWebsiteProperties.AlipayOplatformWebsite getAlipayOplatformWebsiteByAppid(String appid)
	 ...
	 * 拦截处理此异常
	 */
	AlipayOplatformWebsiteTokenResponse getAccessTokenResponse(String appid, String code, String state, String binding,
