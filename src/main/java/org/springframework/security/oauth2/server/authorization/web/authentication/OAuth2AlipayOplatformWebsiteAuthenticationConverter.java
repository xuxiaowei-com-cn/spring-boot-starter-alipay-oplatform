...
/**
 * 支付宝 OAuth2 用于验证授权授予的 {@link OAuth2AlipayOplatformWebsiteAuthenticationToken}。
 *
 * @author xuxiaowei
 * @since Joe Grandja
 * @since 0.0.1
...
public class OAuth2AlipayOplatformWebsiteAuthenticationConverter implements AuthenticationConverter {
	...
	public Authentication convert(HttpServletRequest request) {
		...
		if (!OAuth2AlipayOplatformWebsiteAuthenticationToken.ALIPAY_OPLATFORM_WEBSITE.getValue().equals(grantType)) {
			return null;
		}
